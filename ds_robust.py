...
parser.add_argument('--trainlist', default='/work/vig/tianyed/CFNet/CFNet/filenames/DS_train.txt', help='training list')
parser.add_argument('--testlist', default='/work/vig/tianyed/CFNet/CFNet/filenames/DS_test.txt', help='testing list')
